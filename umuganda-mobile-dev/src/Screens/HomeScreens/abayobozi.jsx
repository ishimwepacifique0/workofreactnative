...
export const Abayobozi = ({ navigation }) => {
  ...
  const [inshingano, setInshingano] = useState('')
  ...
  return (
    <SafeAreaView style={styles.page}>
      ...
      <View style={styles.container}>
        ...
        >
          <AntDesign name="arrowleft" size={24} color="#0E5A64" />
        ...
        />
        <Text style={styles.texts}>Inshingano</Text>
        <LoginTextInput
          placeholder={"Shyiramo Email"}
          Onchange={(text) => setInshingano(text)}
        />
