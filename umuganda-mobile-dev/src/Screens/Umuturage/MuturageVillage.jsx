import {
  ...
  export const MuturageVillage = ({navigation}) => {
    const date = new Date();
    ...
    getItemAsync('token').then((response) => {
    ...
    function getActivity() {
        axios({
            ...
            // const hasReport = response.data.data.some((item) => item.report);
            // // console.log(hasReport, '............................................................./////////////////////')
            // setIsReportAvailable(hasReport)
              ...
              {activity.map((item, key) => {          
                return (
                  <HomeCard
                    ...
                    Onchange={() =>
                      navigation.navigate("MuturageRaporo", {
                        report: item.report,
